...
$(function () {
  ...
  $(".event-toggle").on("click", function () {
    $(this).text(
      $(this).text() == "Hide Details" ? "Show Details" : "Hide Details"
    );
  });
  /* ================================================
      Full Calendar
  ...
  if ($("#instafeed").length) {
    var feed = new Instafeed({
      ...
      template:
        '<div class="instafeed_img"><a href="{{link}}" target="_blank"><div class="instagram_img_holder" style="background-image: url({{image}});"></div><div class="instafeed_img_overlay"><span>Instagram</span></div></a></div>',
      after: function () {
        runInstaCarousel();
      },
      error: function () {
        $("#instafeed").html(
          '<p class="text-center">To setup Instagram feed, Please read the documentation.</p>'
        );
      },
    });
    feed.run();
    ...
    $(".tweet").twittie(
      {
        ...
        hideReplies: true,
        template:
          '<i class="fa fa-twitter fa-tweet" aria-hidden="true"></i> <div> {{tweet}} </div>',
        apiPath: "php/twitter/tweet.php",
        loadingText:
          "Twitter feed will load here. Please read documentation for instructions. <br><br> PS: it will NOT work on localhost or via file. Please upload to a PHP server to test.",
      },
      function () {
        //alert('loaded!');
      }
